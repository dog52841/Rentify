-- This script fixes the database function responsible for fetching listings on the browse page.
-- Running this in your Supabase SQL Editor will resolve the "relation 'ratings' does not exist" error.

-- Drop the old function if it exists, to ensure a clean slate.
DROP FUNCTION IF EXISTS get_listings_with_ratings;
